...
// PaymentResponseSettlementAmount - **Deprecated.** This field will be removed on January 1st, 2027. Use the [Settlements API](list-settlements) or
...
func (p *PaymentResponseDetails) GetBizumReference() *string {
	if p == nil {
		return nil
	}
