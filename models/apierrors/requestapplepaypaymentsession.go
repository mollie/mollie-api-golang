...
// RequestApplePayPaymentSessionHalJSONError - An error response object.
type RequestApplePayPaymentSessionHalJSONError struct {
	...
	Links    operations.RequestApplePayPaymentSessionLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata                       `json:"-"`
}

var _ error = &RequestApplePayPaymentSessionHalJSONError{}

func (e *RequestApplePayPaymentSessionHalJSONError) Error() string {
