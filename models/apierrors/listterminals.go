...
// ListTerminalsHalJSONError - An error response object.
type ListTerminalsHalJSONError struct {
	...
	Links    operations.ListTerminalsBadRequestLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata                 `json:"-"`
}

var _ error = &ListTerminalsHalJSONError{}

func (e *ListTerminalsHalJSONError) Error() string {
