...
// PaymentListRoutesHalJSONError - An error response object.
type PaymentListRoutesHalJSONError struct {
	...
	Links    operations.PaymentListRoutesNotFoundLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata                   `json:"-"`
}

var _ error = &PaymentListRoutesHalJSONError{}

func (e *PaymentListRoutesHalJSONError) Error() string {
