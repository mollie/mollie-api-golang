...
// GetClientHalJSONError - An error response object.
type GetClientHalJSONError struct {
	...
	Links    operations.GetClientNotFoundLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata           `json:"-"`
}

var _ error = &GetClientHalJSONError{}

func (e *GetClientHalJSONError) Error() string {
