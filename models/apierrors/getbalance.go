...
// GetBalanceHalJSONError - An error response object.
type GetBalanceHalJSONError struct {
	...
	Links    operations.GetBalanceNotFoundLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata            `json:"-"`
}

var _ error = &GetBalanceHalJSONError{}

func (e *GetBalanceHalJSONError) Error() string {
