...
// GetTerminalHalJSONError - An error response object.
type GetTerminalHalJSONError struct {
	...
	Links    operations.GetTerminalNotFoundLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata             `json:"-"`
}

var _ error = &GetTerminalHalJSONError{}

func (e *GetTerminalHalJSONError) Error() string {
