...
// CreateProfileHalJSONError - An error response object.
type CreateProfileHalJSONError struct {
	...
	Links    operations.CreateProfileUnprocessableEntityLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata                          `json:"-"`
}

var _ error = &CreateProfileHalJSONError{}

func (e *CreateProfileHalJSONError) Error() string {
