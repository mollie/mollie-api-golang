...
// GetMandateHalJSONError - An error response object.
type GetMandateHalJSONError struct {
	...
	Links    operations.GetMandateNotFoundLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata            `json:"-"`
}

var _ error = &GetMandateHalJSONError{}

func (e *GetMandateHalJSONError) Error() string {
