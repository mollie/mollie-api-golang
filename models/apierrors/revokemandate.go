...
// RevokeMandateHalJSONError - An error response object.
type RevokeMandateHalJSONError struct {
	...
	Links    operations.RevokeMandateLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata       `json:"-"`
}

var _ error = &RevokeMandateHalJSONError{}

func (e *RevokeMandateHalJSONError) Error() string {
