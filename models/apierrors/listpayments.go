...
// ListPaymentsHalJSONError - An error response object.
type ListPaymentsHalJSONError struct {
	...
	Links    operations.ListPaymentsBadRequestLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata                `json:"-"`
}

var _ error = &ListPaymentsHalJSONError{}

func (e *ListPaymentsHalJSONError) Error() string {
