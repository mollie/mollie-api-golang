...
// GetOrganizationHalJSONError - An error response object.
type GetOrganizationHalJSONError struct {
	...
	Links    operations.GetOrganizationNotFoundLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata                 `json:"-"`
}

var _ error = &GetOrganizationHalJSONError{}

func (e *GetOrganizationHalJSONError) Error() string {
