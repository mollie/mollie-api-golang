...
// ListWebhooksHalJSONError - An error response object.
type ListWebhooksHalJSONError struct {
	...
	Links    operations.ListWebhooksBadRequestLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata                `json:"-"`
}

var _ error = &ListWebhooksHalJSONError{}

func (e *ListWebhooksHalJSONError) Error() string {
