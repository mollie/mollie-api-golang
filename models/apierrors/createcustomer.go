...
// CreateCustomerHalJSONError - An error response object.
type CreateCustomerHalJSONError struct {
	...
	Links    operations.CreateCustomerNotFoundLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata                `json:"-"`
}

var _ error = &CreateCustomerHalJSONError{}

func (e *CreateCustomerHalJSONError) Error() string {
