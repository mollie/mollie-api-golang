...
// ListSubscriptionPaymentsHalJSONError - An error response object.
type ListSubscriptionPaymentsHalJSONError struct {
	...
	Links    operations.ListSubscriptionPaymentsBadRequestLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata                            `json:"-"`
}

var _ error = &ListSubscriptionPaymentsHalJSONError{}

func (e *ListSubscriptionPaymentsHalJSONError) Error() string {
