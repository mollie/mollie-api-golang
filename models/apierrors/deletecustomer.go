...
// DeleteCustomerHalJSONError - An error response object.
type DeleteCustomerHalJSONError struct {
	...
	Links    operations.DeleteCustomerLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata        `json:"-"`
}

var _ error = &DeleteCustomerHalJSONError{}

func (e *DeleteCustomerHalJSONError) Error() string {
