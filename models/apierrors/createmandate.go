...
// CreateMandateHalJSONError - An error response object.
type CreateMandateHalJSONError struct {
	...
	Links    operations.CreateMandateNotFoundLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata               `json:"-"`
}

var _ error = &CreateMandateHalJSONError{}

func (e *CreateMandateHalJSONError) Error() string {
