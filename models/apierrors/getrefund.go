...
// GetRefundHalJSONError - An error response object.
type GetRefundHalJSONError struct {
	...
	Links    operations.GetRefundNotFoundLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata           `json:"-"`
}

var _ error = &GetRefundHalJSONError{}

func (e *GetRefundHalJSONError) Error() string {
