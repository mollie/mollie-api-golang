...
// GetChargebackHalJSONError - An error response object.
type GetChargebackHalJSONError struct {
	...
	Links    operations.GetChargebackNotFoundLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata               `json:"-"`
}

var _ error = &GetChargebackHalJSONError{}

func (e *GetChargebackHalJSONError) Error() string {
