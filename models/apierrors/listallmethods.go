...
// ListAllMethodsHalJSONError - An error response object.
type ListAllMethodsHalJSONError struct {
	...
	Links    operations.ListAllMethodsBadRequestLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata                  `json:"-"`
}

var _ error = &ListAllMethodsHalJSONError{}

func (e *ListAllMethodsHalJSONError) Error() string {
