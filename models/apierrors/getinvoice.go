...
// GetInvoiceHalJSONError - An error response object.
type GetInvoiceHalJSONError struct {
	...
	Links    operations.GetInvoiceNotFoundLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata            `json:"-"`
}

var _ error = &GetInvoiceHalJSONError{}

func (e *GetInvoiceHalJSONError) Error() string {
