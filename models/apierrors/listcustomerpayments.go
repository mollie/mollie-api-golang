...
// ListCustomerPaymentsHalJSONError - An error response object.
type ListCustomerPaymentsHalJSONError struct {
	...
	Links    operations.ListCustomerPaymentsBadRequestLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata                        `json:"-"`
}

var _ error = &ListCustomerPaymentsHalJSONError{}

func (e *ListCustomerPaymentsHalJSONError) Error() string {
