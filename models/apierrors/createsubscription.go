...
// CreateSubscriptionHalJSONError - An error response object.
type CreateSubscriptionHalJSONError struct {
	...
	Links    operations.CreateSubscriptionNotFoundLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata                    `json:"-"`
}

var _ error = &CreateSubscriptionHalJSONError{}

func (e *CreateSubscriptionHalJSONError) Error() string {
