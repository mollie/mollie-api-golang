...
// GetCustomerHalJSONError - An error response object.
type GetCustomerHalJSONError struct {
	...
	Links    operations.GetCustomerNotFoundLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata             `json:"-"`
}

var _ error = &GetCustomerHalJSONError{}

func (e *GetCustomerHalJSONError) Error() string {
