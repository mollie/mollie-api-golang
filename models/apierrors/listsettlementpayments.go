...
// ListSettlementPaymentsHalJSONError - An error response object.
type ListSettlementPaymentsHalJSONError struct {
	...
	Links    operations.ListSettlementPaymentsBadRequestLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata                          `json:"-"`
}

var _ error = &ListSettlementPaymentsHalJSONError{}

func (e *ListSettlementPaymentsHalJSONError) Error() string {
