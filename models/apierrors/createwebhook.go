...
// CreateWebhookHalJSONError - An error response object.
type CreateWebhookHalJSONError struct {
	...
	Links    operations.CreateWebhookUnprocessableEntityLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata                          `json:"-"`
}

var _ error = &CreateWebhookHalJSONError{}

func (e *CreateWebhookHalJSONError) Error() string {
