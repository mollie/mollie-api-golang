...
// CancelRefundHalJSONError - An error response object.
type CancelRefundHalJSONError struct {
	...
	Links    operations.CancelRefundLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata      `json:"-"`
}

var _ error = &CancelRefundHalJSONError{}

func (e *CancelRefundHalJSONError) Error() string {
