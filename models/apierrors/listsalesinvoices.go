...
// ListSalesInvoicesHalJSONError - An error response object.
type ListSalesInvoicesHalJSONError struct {
	...
	Links    operations.ListSalesInvoicesBadRequestLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata                     `json:"-"`
}

var _ error = &ListSalesInvoicesHalJSONError{}

func (e *ListSalesInvoicesHalJSONError) Error() string {
