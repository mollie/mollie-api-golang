...
// UpdateCustomerHalJSONError - An error response object.
type UpdateCustomerHalJSONError struct {
	...
	Links    operations.UpdateCustomerNotFoundLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata                `json:"-"`
}

var _ error = &UpdateCustomerHalJSONError{}

func (e *UpdateCustomerHalJSONError) Error() string {
