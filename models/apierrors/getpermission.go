...
// GetPermissionHalJSONError - An error response object.
type GetPermissionHalJSONError struct {
	...
	Links    operations.GetPermissionNotFoundLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata               `json:"-"`
}

var _ error = &GetPermissionHalJSONError{}

func (e *GetPermissionHalJSONError) Error() string {
