...
// GetPaymentHalJSONError - An error response object.
type GetPaymentHalJSONError struct {
	...
	Links    operations.GetPaymentNotFoundLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata            `json:"-"`
}

var _ error = &GetPaymentHalJSONError{}

func (e *GetPaymentHalJSONError) Error() string {
