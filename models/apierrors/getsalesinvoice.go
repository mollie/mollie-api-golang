...
// GetSalesInvoiceHalJSONError - An error response object.
type GetSalesInvoiceHalJSONError struct {
	...
	Links    operations.GetSalesInvoiceNotFoundLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata                 `json:"-"`
}

var _ error = &GetSalesInvoiceHalJSONError{}

func (e *GetSalesInvoiceHalJSONError) Error() string {
