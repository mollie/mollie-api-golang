...
// GetSubscriptionHalJSONError - An error response object.
type GetSubscriptionHalJSONError struct {
	...
	Links    operations.GetSubscriptionNotFoundLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata                 `json:"-"`
}

var _ error = &GetSubscriptionHalJSONError{}

func (e *GetSubscriptionHalJSONError) Error() string {
