...
// ListPermissionsHalJSONError - An error response object.
type ListPermissionsHalJSONError struct {
	...
	Links    operations.ListPermissionsBadRequestLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata                   `json:"-"`
}

var _ error = &ListPermissionsHalJSONError{}

func (e *ListPermissionsHalJSONError) Error() string {
