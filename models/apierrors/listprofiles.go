...
// ListProfilesHalJSONError - An error response object.
type ListProfilesHalJSONError struct {
	...
	Links    operations.ListProfilesBadRequestLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata                `json:"-"`
}

var _ error = &ListProfilesHalJSONError{}

func (e *ListProfilesHalJSONError) Error() string {
