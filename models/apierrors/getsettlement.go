...
// GetSettlementHalJSONError - An error response object.
type GetSettlementHalJSONError struct {
	...
	Links    operations.GetSettlementNotFoundLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata               `json:"-"`
}

var _ error = &GetSettlementHalJSONError{}

func (e *GetSettlementHalJSONError) Error() string {
