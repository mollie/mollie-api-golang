...
// ListMethodsHalJSONError - An error response object.
type ListMethodsHalJSONError struct {
	...
	Links    operations.ListMethodsBadRequestLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata               `json:"-"`
}

var _ error = &ListMethodsHalJSONError{}

func (e *ListMethodsHalJSONError) Error() string {
