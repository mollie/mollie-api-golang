...
// ListPaymentLinksHalJSONError - An error response object.
type ListPaymentLinksHalJSONError struct {
	...
	Links    operations.ListPaymentLinksBadRequestLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata                    `json:"-"`
}

var _ error = &ListPaymentLinksHalJSONError{}

func (e *ListPaymentLinksHalJSONError) Error() string {
