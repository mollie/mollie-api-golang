...
// PaymentCreateRouteHalJSONError - An error response object.
type PaymentCreateRouteHalJSONError struct {
	...
	Links    operations.PaymentCreateRouteNotFoundLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata                    `json:"-"`
}

var _ error = &PaymentCreateRouteHalJSONError{}

func (e *PaymentCreateRouteHalJSONError) Error() string {
