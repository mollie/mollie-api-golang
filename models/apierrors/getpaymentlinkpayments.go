...
// GetPaymentLinkPaymentsHalJSONError - An error response object.
type GetPaymentLinkPaymentsHalJSONError struct {
	...
	Links    operations.GetPaymentLinkPaymentsBadRequestLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata                          `json:"-"`
}

var _ error = &GetPaymentLinkPaymentsHalJSONError{}

func (e *GetPaymentLinkPaymentsHalJSONError) Error() string {
