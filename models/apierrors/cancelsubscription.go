...
// CancelSubscriptionHalJSONError - An error response object.
type CancelSubscriptionHalJSONError struct {
	...
	Links    operations.CancelSubscriptionNotFoundLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata                    `json:"-"`
}

var _ error = &CancelSubscriptionHalJSONError{}

func (e *CancelSubscriptionHalJSONError) Error() string {
