...
// UpdateSubscriptionHalJSONError - An error response object.
type UpdateSubscriptionHalJSONError struct {
	...
	Links    operations.UpdateSubscriptionNotFoundLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata                    `json:"-"`
}

var _ error = &UpdateSubscriptionHalJSONError{}

func (e *UpdateSubscriptionHalJSONError) Error() string {
