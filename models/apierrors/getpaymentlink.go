...
// GetPaymentLinkHalJSONError - An error response object.
type GetPaymentLinkHalJSONError struct {
	...
	Links    operations.GetPaymentLinkNotFoundLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata                `json:"-"`
}

var _ error = &GetPaymentLinkHalJSONError{}

func (e *GetPaymentLinkHalJSONError) Error() string {
