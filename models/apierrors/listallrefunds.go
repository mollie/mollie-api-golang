...
// ListAllRefundsHalJSONError - An error response object.
type ListAllRefundsHalJSONError struct {
	...
	Links    operations.ListAllRefundsBadRequestLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata                  `json:"-"`
}

var _ error = &ListAllRefundsHalJSONError{}

func (e *ListAllRefundsHalJSONError) Error() string {
