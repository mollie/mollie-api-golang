...
// GetCaptureHalJSONError - An error response object.
type GetCaptureHalJSONError struct {
	...
	Links    operations.GetCaptureNotFoundLinks `json:"_links"`
	HTTPMeta components.HTTPMetadata            `json:"-"`
}

var _ error = &GetCaptureHalJSONError{}

func (e *GetCaptureHalJSONError) Error() string {
