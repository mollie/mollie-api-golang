...
type ListCapturesGlobals struct {
...
func (l *ListCapturesGlobals) GetTestmode() *bool {
	if l == nil {
		return nil
	}
	return l.Testmode
...
func (l *ListCapturesEmbedded) GetCaptures() []components.ListCaptureResponse {
	if l == nil {
...
type ListCapturesResponse struct {
	...
	Next func() (*ListCapturesResponse, error)
}
