...
type ListCustomerPaymentsGlobals struct {
...
func (l *ListCustomerPaymentsGlobals) GetProfileID() *string {
	if l == nil {
		return nil
	}
	return l.ProfileID
...
func (l *ListCustomerPaymentsGlobals) GetTestmode() *bool {
	if l == nil {
		return nil
	}
	return l.Testmode
...
func (l *ListCustomerPaymentsRequest) GetSort() *components.Sorting {
	if l == nil {
		return nil
	}
	return l.Sort
...
func (l *ListCustomerPaymentsEmbedded) GetPayments() []components.ListPaymentResponse {
	if l == nil {
		return nil
	}
	return l.Payments
...
func (l *ListCustomerPaymentsResponseBody) GetCount() int64 {
	if l == nil {
		return 0
	}
	return l.Count
...
func (l *ListCustomerPaymentsResponseBody) GetEmbedded() ListCustomerPaymentsEmbedded {
	if l == nil {
...
func (l *ListCustomerPaymentsResponseBody) GetLinks() components.ListLinks {
	if l == nil {
...
type ListCustomerPaymentsResponse struct {
	...
	Next func() (*ListCustomerPaymentsResponse, error)
}

func (l *ListCustomerPaymentsResponse) GetHTTPMeta() components.HTTPMetadata {
	if l == nil {
...
func (l *ListCustomerPaymentsResponse) GetObject() *ListCustomerPaymentsResponseBody {
	if l == nil {
		return nil
	}
	return l.Object
