...
type ListSubscriptionsGlobals struct {
...
func (l *ListSubscriptionsGlobals) GetTestmode() *bool {
	if l == nil {
		return nil
	}
	return l.Testmode
...
func (l *ListSubscriptionsRequest) GetSort() *components.Sorting {
	if l == nil {
		return nil
	}
	return l.Sort
...
func (l *ListSubscriptionsEmbedded) GetSubscriptions() []components.ListSubscriptionResponse {
	if l == nil {
		return nil
	}
