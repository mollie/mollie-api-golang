...
type ListChargebacksGlobals struct {
...
func (l *ListChargebacksGlobals) GetTestmode() *bool {
	if l == nil {
		return nil
	}
	return l.Testmode
...
func (l *ListChargebacksEmbedded) GetChargebacks() []components.ListEntityChargeback {
	if l == nil {
...
type ListChargebacksResponseBody struct {
	...
	Embedded ListChargebacksEmbedded `json:"_embedded"`
...
func (l *ListChargebacksResponseBody) GetEmbedded() ListChargebacksEmbedded {
	if l == nil {
		return ListChargebacksEmbedded{}
	}
	return l.Embedded
}
...
type ListChargebacksResponse struct {
	...
	Next func() (*ListChargebacksResponse, error)
}
