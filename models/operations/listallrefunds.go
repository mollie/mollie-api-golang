...
type ListAllRefundsGlobals struct {
...
func (l *ListAllRefundsGlobals) GetProfileID() *string {
	if l == nil {
		return nil
	}
	return l.ProfileID
...
func (l *ListAllRefundsGlobals) GetTestmode() *bool {
	if l == nil {
		return nil
	}
	return l.Testmode
