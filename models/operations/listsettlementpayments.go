...
// ListSettlementPaymentsDestinationType - The type of destination. Currently only the destination type `organization` is supported.
type ListSettlementPaymentsDestinationType string

const (
	ListSettlementPaymentsDestinationTypeOrganization ListSettlementPaymentsDestinationType = "organization"
)

func (e ListSettlementPaymentsDestinationType) ToPointer() *ListSettlementPaymentsDestinationType {
	return &e
}
...
type ListSettlementPaymentsDestination struct {
	...
	Type ListSettlementPaymentsDestinationType `json:"type"`
	// Required for destination type `organization`. The ID of the connected organization the funds should be
	// routed to.
	OrganizationID string `json:"organizationId"`
}

func (o *ListSettlementPaymentsDestination) GetType() ListSettlementPaymentsDestinationType {
	if o == nil {
		return ListSettlementPaymentsDestinationType("")
	}
	return o.Type
}
