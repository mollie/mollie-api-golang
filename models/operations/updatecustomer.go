...
func (e *UpdateCustomerMode) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "live":
		fallthrough
	case "test":
		*e = UpdateCustomerMode(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateCustomerMode: %v", v)
	}
}
...
func (e *UpdateCustomerLocaleResponse) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "lv_LV":
		fallthrough
	case "lt_LT":
		*e = UpdateCustomerLocaleResponse(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateCustomerLocaleResponse: %v", v)
	}
}
