...
func (l *ListSubscriptionPaymentsEmbedded) GetPayments() []components.ListPaymentResponse {
	if l == nil {
		return nil
	}
	return l.Payments
...
type ListSubscriptionPaymentsResponse struct {
	...
	Next func() (*ListSubscriptionPaymentsResponse, error)
}
