...
// GetPaymentDestinationType - The type of destination. Currently only the destination type `organization` is supported.
type GetPaymentDestinationType string

const (
	GetPaymentDestinationTypeOrganization GetPaymentDestinationType = "organization"
)

func (e GetPaymentDestinationType) ToPointer() *GetPaymentDestinationType {
	return &e
}
...
type GetPaymentDestination struct {
	...
	Type GetPaymentDestinationType `json:"type"`
	// Required for destination type `organization`. The ID of the connected organization the funds should be
	// routed to.
	OrganizationID string `json:"organizationId"`
}

func (o *GetPaymentDestination) GetType() GetPaymentDestinationType {
	if o == nil {
		return GetPaymentDestinationType("")
	}
	return o.Type
}
