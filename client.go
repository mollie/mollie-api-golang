...
// Generated from OpenAPI doc version 1.0.0 and generator version 2.695.1
...
func New(opts ...SDKOption) *Client {
	sdk := &Client{
		SDKVersion: "0.2.3",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.2.3 2.695.1 1.0.0 github.com/mollie/mollie-api-golang",
