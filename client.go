...
// Generated from OpenAPI doc version 1.0.0 and generator version 2.792.2
...
func New(opts ...SDKOption) *Client {
	sdk := &Client{
		SDKVersion: "0.9.9",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.9.9 2.792.2 1.0.0 github.com/mollie/mollie-api-golang",
