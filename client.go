...
// Generated from OpenAPI doc version 1.0.0 and generator version 2.884.0
...
func New(opts ...SDKOption) *Client {
	sdk := &Client{
		SDKVersion: "1.1.2",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 1.1.2 2.884.0 1.0.0 github.com/mollie/mollie-api-golang",
