...
func newMethods(rootSDK *Client, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Methods {
	return &Methods{
		rootSDK:          rootSDK,
...
func (s *Methods) List(ctx context.Context, request operations.ListMethodsRequest, opts ...operations.Option) (*operations.ListMethodsResponse, error) {
	...
	res := &operations.ListMethodsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/hal+json`):
			...
			var out operations.ListMethodsResponseBody
	...
	case httpRes.StatusCode == 400:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/hal+json`):
			...
			var out apierrors.ListMethodsHalJSONError
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Methods) All(ctx context.Context, request operations.ListAllMethodsRequest, opts ...operations.Option) (*operations.ListAllMethodsResponse, error) {
	...
	res := &operations.ListAllMethodsResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/hal+json`):
			...
			var out operations.ListAllMethodsResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
	...
	case httpRes.StatusCode == 400:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/hal+json`):
			...
			var out apierrors.ListAllMethodsHalJSONError
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Methods) Get(ctx context.Context, request operations.GetMethodRequest, opts ...operations.Option) (*operations.GetMethodResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/hal+json`):
			...
			var out operations.GetMethodResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
	...
	case httpRes.StatusCode == 400:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/hal+json`):
			...
			var out apierrors.GetMethodBadRequestHalJSONError
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
	...
	case httpRes.StatusCode == 404:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/hal+json`):
			...
			var out apierrors.GetMethodNotFoundHalJSONError
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
