...
func newOnboarding(rootSDK *Client, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Onboarding {
	return &Onboarding{
		rootSDK:          rootSDK,
...
func (s *Onboarding) Submit(ctx context.Context, idempotencyKey *string, requestBody *operations.SubmitOnboardingDataRequestBody, opts ...operations.Option) (*operations.SubmitOnboardingDataResponse, error) {
	...
	res := &operations.SubmitOnboardingDataResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
