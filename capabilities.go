...
func newCapabilities(rootSDK *Client, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Capabilities {
	return &Capabilities{
		rootSDK:          rootSDK,
...
func (s *Capabilities) List(ctx context.Context, idempotencyKey *string, opts ...operations.Option) (*operations.ListCapabilitiesResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/hal+json`):
			...
			var out operations.ListCapabilitiesResponseBody
