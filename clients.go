...
func newClients(rootSDK *Client, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Clients {
	return &Clients{
		rootSDK:          rootSDK,
...
func (s *Clients) List(ctx context.Context, embed *string, from *string, limit *int64, opts ...operations.Option) (*operations.ListClientsResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/hal+json`):
			...
			var out operations.ListClientsResponseBody
	...
	case httpRes.StatusCode == 400:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/hal+json`):
			...
			var out apierrors.ListClientsBadRequestHalJSONError
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
	...
	case httpRes.StatusCode == 404:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/hal+json`):
			...
			var out apierrors.ListClientsNotFoundHalJSONError
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Clients) Get(ctx context.Context, id string, embed *string, opts ...operations.Option) (*operations.GetClientResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/hal+json`):
			...
			var out operations.GetClientResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
	...
	case httpRes.StatusCode == 404:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/hal+json`):
			...
			var out apierrors.GetClientHalJSONError
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
