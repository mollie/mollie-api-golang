...
func main() {
    ...
    res, err := s.Permissions.List(ctx, client.String("123e4567-e89b-12d3-a456-426"))
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
func main() {
    ...
    res, err := s.Permissions.Get(ctx, "payments.read", client.Bool(false), client.String("123e4567-e89b-12d3-a456-426"))
    if err != nil {
        log.Fatal(err)
    }
