...
func main() {
    ...
    res, err := s.Payments.Create(ctx, client.String("details.qrCode"), client.String("123e4567-e89b-12d3-a456-426"), &components.PaymentRequest{
...
func main() {
    ...
    res, err := s.Payments.Get(ctx, operations.GetPaymentRequest{
        ...
        Include: client.String("details.qrCode"),
        Embed: client.String("captures"),
        Testmode: client.Bool(false),
        IdempotencyKey: client.String("123e4567-e89b-12d3-a456-426"),
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Payments.Update(ctx, "tr_5B8cwPMGnU", client.String("123e4567-e89b-12d3-a456-426"), &operations.UpdatePaymentRequestBody{
        Description: client.String("Chess Board"),
        RedirectURL: client.String("https://example.org/redirect"),
        CancelURL: client.String("https://example.org/cancel"),
        WebhookURL: client.String("https://example.org/webhooks"),
...
func main() {
    ...
    res, err := s.Payments.Cancel(ctx, "tr_5B8cwPMGnU", client.String("123e4567-e89b-12d3-a456-426"), &operations.CancelPaymentRequestBody{
        Testmode: client.Bool(false),
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Payments.ReleaseAuthorization(ctx, "tr_5B8cwPMGnU", client.String("123e4567-e89b-12d3-a456-426"), &operations.ReleaseAuthorizationRequestBody{
        ProfileID: client.String("pfl_5B8cwPMGnU"),
        Testmode: client.Bool(false),
    })
    if err != nil {
