...
<!-- UsageSnippet language="go" operationID="create-session" method="post" path="/v2/sessions" example="create-session-201-1" -->
```go
package main
...
<!-- UsageSnippet language="go" operationID="get-session" method="get" path="/v2/sessions/{sessionId}" example="get-session-200-1" -->
```go
package main
