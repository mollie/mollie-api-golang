...
<!-- UsageSnippet language="go" operationID="request-apple-pay-payment-session" method="post" path="/v2/wallets/applepay/sessions" example="request-apple-pay-payment-session-201-1" -->
```go
package main
