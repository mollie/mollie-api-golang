...
| Error Type                       | Status Code                      | Content Type                     |
| -------------------------------- | -------------------------------- | -------------------------------- |
| apierrors.GetBalanceHalJSONError | 404                              | application/hal+json             |
| apierrors.APIError               | 4XX, 5XX                         | \*/\*                            |
...
func main() {
    ...
    res, err := s.Balances.GetReport(ctx, operations.GetBalanceReportRequest{
        ...
        From: "2024-01-01",
        Until: "2024-02-01",
        Grouping: operations.QueryParamGroupingStatusBalances.ToPointer(),
...
| Error Type                                                | Status Code                                               | Content Type                                              |
| --------------------------------------------------------- | --------------------------------------------------------- | --------------------------------------------------------- |
| apierrors.GetBalanceReportNotFoundHalJSONError            | 404                                                       | application/hal+json                                      |
| apierrors.GetBalanceReportUnprocessableEntityHalJSONError | 422                                                       | application/hal+json                                      |
| apierrors.APIError                                        | 4XX, 5XX                                                  | \*/\*                                                     |
...
| Error Type                                              | Status Code                                             | Content Type                                            |
| ------------------------------------------------------- | ------------------------------------------------------- | ------------------------------------------------------- |
| apierrors.ListBalanceTransactionsBadRequestHalJSONError | 400                                                     | application/hal+json                                    |
| apierrors.ListBalanceTransactionsNotFoundHalJSONError   | 404                                                     | application/hal+json                                    |
| apierrors.TooManyRequestsHalJSONError                   | 429                                                     | application/hal+json                                    |
| apierrors.APIError                                      | 4XX, 5XX                                                | \*/\*                                                   |