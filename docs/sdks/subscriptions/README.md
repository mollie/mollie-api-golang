...
func main() {
    ...
    res, err := s.Subscriptions.Get(ctx, "cst_5B8cwPMGnU", "sub_5B8cwPMGnU", client.Bool(false))
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
func main() {
    ...
    res, err := s.Subscriptions.Cancel(ctx, "cst_5B8cwPMGnU", "sub_5B8cwPMGnU", &operations.CancelSubscriptionRequestBody{
        Testmode: client.Bool(false),
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Subscriptions.All(ctx, client.String("sub_rVKGtNd6s3"), client.Int64(50), client.String("pfl_QkEhN94Ba"), client.Bool(false))
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
