    ...
    if res.CustomerResponse != nil {
        switch res.CustomerResponse.Metadata.Type {
            ...
            case components.MetadataTypeNumber:
                // res.CustomerResponse.Metadata.Number is populated
...
func main() {
    ...
    res, err := s.Customers.Get(ctx, "cst_5B8cwPMGnU", client.Pointer("events"), client.Pointer("123e4567-e89b-12d3-a456-426"))
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
        switch res.Object.Metadata.Type {
            ...
            case components.MetadataTypeNumber:
                // res.Object.Metadata.Number is populated
            case components.MetadataTypeMapOfAny:
...
func main() {
    ...
    res, err := s.Customers.CreatePayment(ctx, "cst_5B8cwPMGnU", client.Pointer("123e4567-e89b-12d3-a456-426"), &components.PaymentRequest{
        ...
        GooglePayPaymentToken: client.Pointer("{\"signature\": \"MEYCIQCv...\", \"protocolVersion\": \"ECv2\", \"signedMessage\": \"{\\\"encryptedMessage\\\":\\\"...\\\",\\\"ephemeralPublicKey\\\":\\\"...\\\",\\\"tag\\\":\\\"...\\\"}\"}"),
