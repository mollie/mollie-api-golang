...
func main() {
    ...
    res, err := s.Organizations.Get(ctx, "org_12345678", client.Bool(false))
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
| ------------------------------------- | ------------------------------------- | ------------------------------------- |
| apierrors.GetOrganizationHalJSONError | 404                                   | application/hal+json                  |
...
func main() {
    ...
    res, err := s.Organizations.GetPartner(ctx)
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
