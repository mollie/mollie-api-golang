...
func newInvoices(rootSDK *Client, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Invoices {
	return &Invoices{
		rootSDK:          rootSDK,
...
func (s *Invoices) List(ctx context.Context, request operations.ListInvoicesRequest, opts ...operations.Option) (*operations.ListInvoicesResponse, error) {
	...
	case httpRes.StatusCode == 400:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/hal+json`):
			...
			var out apierrors.ListInvoicesBadRequestHalJSONError
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
	...
	case httpRes.StatusCode == 404:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/hal+json`):
			...
			var out apierrors.ListInvoicesNotFoundHalJSONError
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Invoices) Get(ctx context.Context, id string, opts ...operations.Option) (*operations.GetInvoiceResponse, error) {
	...
	case httpRes.StatusCode == 404:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/hal+json`):
			...
			var out apierrors.GetInvoiceHalJSONError
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
